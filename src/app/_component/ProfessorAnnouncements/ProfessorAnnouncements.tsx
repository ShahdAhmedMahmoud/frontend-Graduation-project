...
// // export default function ProfessorAnnouncements({ refreshTrigger }: { refreshTrigger?: number }) {
...
// //   useEffect(() => { fetchAnnouncements(); }, [session?.token, refreshTrigger]);
...
//   // Refetch whenever the token changes OR the parent bumps refreshTrigger
//   // (e.g. right after a new announcement/meeting is created)
//   useEffect(() => {
//     fetchAnnouncements();
//     // eslint-disable-next-line react-hooks/exhaustive-deps
//   }, [session?.token, refreshTrigger]);
...
// Ensures the meeting link always has a protocol, so clicking it opens
// as an external link instead of being treated as a relative path on the site.
          ...
          {display.map((item) => {
            ...
            return (
              <div key={item._id} className="py-4 first:pt-0 last:pb-0">
                ...
                {item.meeting && (
                  <a
                    href={normalizeMeetingUrl(item.meeting.meetingUrl)}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block rounded-lg bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 p-3 mb-3 hover:bg-blue-100 dark:hover:bg-blue-900/30 hover:border-blue-300 dark:hover:border-blue-700 transition cursor-pointer"
                  >
                    <div className="flex items-center gap-2 mb-2">
                      <Bell size={14} className="text-blue-500" />
                      <h4 className="text-xs font-semibold text-gray-900 dark:text-white">{item.meeting.title}</h4>
                    ...
                    <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded bg-blue-600 text-white text-xs font-semibold hover:bg-blue-700 transition">
                      Join Meeting <ExternalLink size={11} />
                    </span>
                  </a>
                )}
