  ...
  return (
    <div>
      ...
      <div className="px-4 pt-3 pb-4 space-y-2.5">
        {filtered.length === 0 ? (
          <div className="text-center py-10 text-gray-400 text-sm">No classes this day 🎉</div>
        ) : (
          filtered.map((item) => {
            ...
            return (
              <div key={String(item.id)} className={`flex items-stretch gap-3 rounded-xl p-3.5 ${color.light}`}>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">{item.instructor}</p>
      ...
      <div className="min-w-[800px]">
        ...
        <div className="relative flex" style={{ height: `${TOTAL_HOURS * SLOT_HEIGHT}px` }}>
          ...
          <div
            ...
            style={{ gridTemplateColumns: `repeat(${NUM_DAYS}, 1fr)` }}
          >
            {/* Hour Lines */}
            {hours.map((hour) => (
              <div
            ...
            {schedule.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-xs opacity-80 truncate mt-0.5">{item.instructor}</p>
                  {height > 50 && (
                    <>
...
export default function Timetable() {
  ...
  useEffect(() => {
    async function fetchTimetable() {
      ...
      try {
        const res = await fetch("http://localhost:5000/api/students/timetable", {
