...
export default function SettingsPage() {
  ...
  // ✅ Apply dark mode to <html> whenever settings.darkMode changes
  useEffect(() => {
  ...
  // ✅ Apply language/direction to <html> whenever settings.language changes
  useEffect(() => {
  ...
  const savePreferences = async () => {
    try {
      const response = await fetch(
        "http://localhost:5000/api/students/me/preferences",
        {
          method: "PATCH",
          headers: {
